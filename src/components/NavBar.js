          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://linkedin.com/in/ramy-ç-255803342" target="_blank"><img src={navIcon1} alt="" /></a>
                <a href="https://github.com/Ramy-Ch" target="_blank"><img src={navIcon2} alt="" /></a>
              </div>
              <HashLink to='#connect'>
